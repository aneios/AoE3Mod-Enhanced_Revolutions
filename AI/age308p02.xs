...
/* age308p02.xs
   ...
   This the main enemy AI for this scenario. "The Fountain of Youth?" scenario.  
   AI has Fort walls, starting base are, econ, navy, everything.  
   It would be great if this AI would both periodically attack with its boats and 
   train some units via boats to the south shore of the lake, attack.
*/
//==============================================================================
