...
/* age3hb08p03.xs
   ...
   Player 2, Green Teammate, defensive
...
void preInit(void)
{
	...
	btRushBoom = 0.0;   // Tendency to boom
	
    btBiasNative = -1.0;
    btBiasTrade = -1.0;
	
	cvDefenseReflexRadiusActive = 35.0;    // When the AI is in a defense reflex, this is the engage range from that base's center.
...
void postInit(void)
{
   ...
   kbSetPlayerHandicap(cMyID,kbGetPlayerHandicap(cMyID)*0.75);  // Handicap.  65% 
}