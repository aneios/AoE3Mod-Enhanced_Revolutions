...
//	rmSetMapElevationHeightBlend(1);
	...
	int avoidElkFar = rmCreateTypeDistanceConstraint("avoid Elk far", "Elk", 75.0);
	...
	int avoidGoldFar = rmCreateClassDistanceConstraint ("gold avoid gold far", rmClassID("Gold"), 62.0+1*PlayerNum);
...
//	rmSetAreaTerrainType(spurbottomID, "new_england\ground2_cliff_ne"); // for testing
	...
	for (i=0; < 2)
	{
		...
		if (i == 0)
		{
			rmSetAreaSize(cliffID, cliffAreaSize, cliffAreaSize);
			...
			//rmAddAreaTerrainLayer(cliffID, "araucania\ground_dirt3_ara", 0, 1+0.34*PlayerNum);
            /*
            rmAddAreaTerrainLayer(cliffID, "araucania\ground_dirt1_ara", 1+0.34*PlayerNum, 4+0.34*PlayerNum);
			rmAddAreaTerrainLayer(cliffID, "araucania\ground_snow1_ara", 4+0.34*PlayerNum, 6+0.34*PlayerNum);
			rmAddAreaTerrainLayer(cliffID, "araucania\ground_snow2_ara", 6+0.34*PlayerNum, 7+0.34*PlayerNum);
			rmAddAreaTerrainLayer(cliffID, "araucania\ground_snow3_ara", 7+0.34*PlayerNum, 9+0.34*PlayerNum);
            */
            rmAddAreaTerrainLayer(cliffID, "araucania\ground_snow3_ara", 8+0.34*PlayerNum, 10+0.34*PlayerNum);
            rmAddAreaTerrainLayer(cliffID, "araucania\ground_snow2_ara", 6+0.34*PlayerNum, 7+0.34*PlayerNum);
            rmAddAreaTerrainLayer(cliffID, "patagonia\ground_snow1_pat", 4+0.34*PlayerNum, 6+0.34*PlayerNum);
            rmAddAreaTerrainLayer(cliffID, "patagonia\ground_dirt3_pat", 3+0.34*PlayerNum, 4+0.34*PlayerNum);
            rmAddAreaTerrainLayer(cliffID, "patagonia\ground_dirt1_pat", 1.5+0.34*PlayerNum, 3+0.34*PlayerNum);
            rmAddAreaTerrainLayer(cliffID, "NWterritory\ground_grass3_nwt", 0, 1.5+0.34*PlayerNum);
	...
	for (i=0; < 2)
	{
        ...
        //patagonia\ground_dirt1_pat
			rmSetAreaSize(cliff2ID, cliffAreaSize, cliffAreaSize);
            ...
            /*
			rmAddAreaTerrainLayer(cliff2ID, "araucania\ground_dirt3_ara", 0, 1+0.34*PlayerNum);
            rmAddAreaTerrainLayer(cliff2ID, "araucania\ground_dirt1_ara", 1+0.34*PlayerNum, 4+0.34*PlayerNum);
			rmAddAreaTerrainLayer(cliff2ID, "araucania\ground_snow1_ara", 4+0.34*PlayerNum, 6+0.34*PlayerNum);
			rmAddAreaTerrainLayer(cliff2ID, "araucania\ground_snow2_ara", 6+0.34*PlayerNum, 7+0.34*PlayerNum);
			rmAddAreaTerrainLayer(cliff2ID, "araucania\ground_snow3_ara", 7+0.34*PlayerNum, 9+0.34*PlayerNum);
            */
            rmAddAreaTerrainLayer(cliff2ID, "araucania\ground_snow3_ara", 8+0.34*PlayerNum, 10+0.34*PlayerNum);
            rmAddAreaTerrainLayer(cliff2ID, "araucania\ground_snow2_ara", 6+0.34*PlayerNum, 7+0.34*PlayerNum);
            rmAddAreaTerrainLayer(cliff2ID, "patagonia\ground_snow1_pat", 4+0.34*PlayerNum, 6+0.34*PlayerNum);
            rmAddAreaTerrainLayer(cliff2ID, "patagonia\ground_dirt3_pat", 3+0.34*PlayerNum, 4+0.34*PlayerNum);
            rmAddAreaTerrainLayer(cliff2ID, "patagonia\ground_dirt1_pat", 1.5+0.34*PlayerNum, 3+0.34*PlayerNum);
            rmAddAreaTerrainLayer(cliff2ID, "NWterritory\ground_grass3_nwt", 0, 1.5+0.34*PlayerNum);
	...
	for (i=0; < 2)
	{
		...
		if (i == 0)
		{
			rmSetAreaSize(cliff3ID, cliffAreaSize, cliffAreaSize);
            ...
            /*
			rmAddAreaTerrainLayer(cliff3ID, "araucania\ground_dirt3_ara", 0, 1+0.34*PlayerNum);
            rmAddAreaTerrainLayer(cliff3ID, "patagonia\ground_dirt1_pat", 2+0.34*PlayerNum, 4+0.34*PlayerNum);
            rmAddAreaTerrainLayer(cliff3ID, "patagonia\ground_dirt3_pat", 4+0.34*PlayerNum, 6+0.34*PlayerNum);
			rmAddAreaTerrainLayer(cliff3ID, "araucania\ground_snow2_ara", 6+0.34*PlayerNum, 7+0.34*PlayerNum);
			rmAddAreaTerrainLayer(cliff3ID, "araucania\ground_snow3_ara", 7+0.34*PlayerNum, 9+0.34*PlayerNum);
            */
            rmAddAreaTerrainLayer(cliff3ID, "araucania\ground_snow3_ara", 8+0.34*PlayerNum, 10+0.34*PlayerNum);
            rmAddAreaTerrainLayer(cliff3ID, "araucania\ground_snow2_ara", 6+0.34*PlayerNum, 7+0.34*PlayerNum);
            rmAddAreaTerrainLayer(cliff3ID, "patagonia\ground_snow1_pat", 4+0.34*PlayerNum, 6+0.34*PlayerNum);
            rmAddAreaTerrainLayer(cliff3ID, "patagonia\ground_dirt3_pat", 3+0.34*PlayerNum, 4+0.34*PlayerNum);
            rmAddAreaTerrainLayer(cliff3ID, "patagonia\ground_dirt1_pat", 1.5+0.34*PlayerNum, 3+0.34*PlayerNum);
            rmAddAreaTerrainLayer(cliff3ID, "NWterritory\ground_grass3_nwt", 0, 1.5+0.34*PlayerNum);
...
*/
	...
	rmAddObjectDefItem(playerTreeID, "ypTreeHimalayas", rmRandInt(6,7), 7.0);
	rmAddObjectDefItem(playerTreeID, "ypTreeHimalayas", rmRandInt(5,6), 8.0);
...
//		rmAddAreaConstraint(mforestID, avoidEdge);
		...
		int mforesttreeID = rmCreateObjectDef("mountain forest trees"+i+" ");
		...
		//	rmAddObjectDefConstraint(mforesttreeID, avoidForestShort);
			...
			rmPlaceObjectDefAtLoc(mforesttreeID, 0, 0.50, 0.50, 10);
	}

	rmSetStatusText("",0.70);

	// Valley forest
	int valleyforestcount = 6+2*PlayerNum;
...
//		rmAddAreaConstraint(vforestID, avoidEdge);
		...
		int vforesttreeID = rmCreateObjectDef("forest valley trees"+i+" ");
			rmAddObjectDefItem(vforesttreeID, "ypTreeHimalayas", rmRandInt(1,2), 2.0);
			rmAddObjectDefItem(vforesttreeID, "ypTreeHimalayas", rmRandInt(1,3), 4.0);
		...
		//	rmAddObjectDefConstraint(vforesttreeID, avoidForestShort);
			...
			rmPlaceObjectDefAtLoc(vforesttreeID, 0, 0.50, 0.50, 8);
	}

	rmSetStatusText("",0.80);

	// Random mountain trees 
	int treeMcount = 4+1*PlayerNum;
	
	for (i=0; < treeMcount)
	{
		int randomMtreeID = rmCreateObjectDef("random mountain tree "+i);
		rmAddObjectDefItem(randomMtreeID, "ypTreeHimalayas", rmRandInt(2,2), 3.0);
	...
	// Random valley trees 
	int treeVcount = 2+8*PlayerNum;

	int randomVtreeID = rmCreateObjectDef("random valley tree ");
		rmAddObjectDefItem(randomVtreeID, "ypTreeHimalayas", rmRandInt(2,3), 6.0);
		rmAddObjectDefItem(randomVtreeID, "ypTreeHimalayas", rmRandInt(1,2), 5.0);
		...
		rmPlaceObjectDefAtLoc(randomVtreeID, 0, 0.50, 0.50, treeVcount);
...
//			rmAddObjectDefConstraint(mooseherdID, stayNE);
	...
	int treasure1count = 2+PlayerNum;
	int treasure2count = 5+PlayerNum;
	int treasure3count = PlayerNum;
	int treasure4count = PlayerNum/2;
...
//		rmPlaceObjectDefAtLoc(Nugget1ID, 0, 0.50, 0.50);
	...
	int fishcount = 5*PlayerNum;
	int whalecount = 2+2*PlayerNum;
	...
	for (i=0; < fishcount)
	{
		...
		rmAddObjectDefConstraint(fishID, avoidWhale);
