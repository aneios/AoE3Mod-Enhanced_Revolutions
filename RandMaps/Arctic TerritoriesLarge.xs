...
void main(void)
{
	...
	int avoidCoin = rmCreateTypeDistanceConstraint("avoid coin", "MineTin", 66.0);
	...
	int avoidMuskOx = rmCreateTypeDistanceConstraint("avoid muskox", "muskOx", 64.0);
	int avoidMoose = rmCreateTypeDistanceConstraint("avoid moose", "moose", 24.0);
	int avoidCaribou = rmCreateTypeDistanceConstraint("avoid caribou", "caribou", 80.0);
	...
	int avoidNuggetStart = rmCreateTypeDistanceConstraint("nugget avoid nugget start", "AbstractNugget", 30.0);
	...
	rmSetAreaSize(avanceeBasGauche, 0.013 * coeff, 0.013 * coeff);
	...
	rmSetAreaSize(avanceeBasDroite, 0.013 * coeff, 0.013 * coeff);
    ...
    */
	...
	rmPlaceObjectDefAtLoc(CaribouID, 0, 0.5, 0.5, 2+PlayerNum * 3);
	...
	rmPlaceObjectDefAtLoc(MuskOXID, 0, 0.5, 0.5, PlayerNum * 3);
