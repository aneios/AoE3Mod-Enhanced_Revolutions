...
//	rmEchoInfo("subCiv0 is Huron "+subCiv0);
	...
	int avoidTradeRouteSocket = rmCreateTypeDistanceConstraint("avoid trade route socket", "socketTradeRoute", 4.0);
...
//	rmAddObjectDefConstraint(playergold2ID, avoidGoldType);
	...
	rmSetObjectDefMinDistance(playerIbexID, 14.0);
	rmSetObjectDefMaxDistance(playerIbexID, 14.0);
    ...
    rmSetObjectDefMaxDistance(playerIbex2ID, 38);
