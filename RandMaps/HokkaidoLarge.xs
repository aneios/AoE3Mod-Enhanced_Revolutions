...
//   rmTerrainInitialize("grass");
   ...
   //Constraints
   int avoidVolcanoFar=rmCreateClassDistanceConstraint("stuff vs. volcano far", rmClassID("classPlateau"), 75.0);
   ...
   int avoidHunt=rmCreateTypeDistanceConstraint("hunts avoid hunts", "huntable", 60.0);
   int waterHunt = rmCreateTerrainMaxDistanceConstraint("hunts stay near the water", "land", false, 10.0);

   int avoidHerd=rmCreateTypeDistanceConstraint("herds avoid herds", "herdable", 64.0);
   int avoidHunt2=rmCreateTypeDistanceConstraint("herds avoid herds2", "herdable", 45.0);
   ...
   int avoidNugget=rmCreateTypeDistanceConstraint("nugget avoid nugget", "AbstractNugget", 75.0);
...
//builds the central mountain
   ...
   rmAddObjectDefItem(foodID, "ypSerow", 8, 5.0);
   ...
   rmAddObjectDefConstraint(foodID3, avoidVolcanoFar);
   ...
   rmAddObjectDefItem(mapTrees, "ypTreeJapaneseMaple", rmRandInt(15,18), rmRandFloat(15.0,18.0));
   ...
   int fishVsFishID2=rmCreateTypeDistanceConstraint("fish v fish2", "ypSquid", 15.0);
   int fishLand = rmCreateTerrainDistanceConstraint("fish land", "land", true, 6.0);
   int avoidWhale=rmCreateTypeDistanceConstraint("fish v whale", "MinkeWhale", 5.0);
   ...
   rmPlaceObjectDefAtLoc(fish2ID, 0, 0.5, 0.5, 3*cNumberNonGaiaPlayers);
