   ...
   rmBuildAllAreas();
	...
	{ 
        ...
        if(true)
		{
			...
			int riverID = rmRiverCreate(-1, "Andes River", 1, 1, 6+cNumberNonGaiaPlayers/2, 6+cNumberNonGaiaPlayers/2);
			...
			int river2ID = rmRiverCreate(-1, "Andes River", 1, 1, 6+cNumberNonGaiaPlayers/2, 6+cNumberNonGaiaPlayers/2);
...
//	rmSetAreaMix(midIslandID, "testmix"); 	// for testing
	...
	for(i=0; <numTries)
	{
	   ...
	   rmSetAreaSize(cliffID, rmAreaTilesToFraction(269));
