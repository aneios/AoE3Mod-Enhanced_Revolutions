...
//********************************************************************************//
   ...
   rmAddObjectDefConstraint(northWhales, avoidAllMedium);
   ...
   rmAddObjectDefConstraint(southWhales, avoidAllMedium);
   ...
   rmSetObjectDefMaxDistance(northFish, rmXFractionToMeters(0.60));
   rmAddObjectDefConstraint(northFish, northTeam);
   rmAddObjectDefConstraint(northFish, avoidAllMedium);
   rmAddObjectDefConstraint(northFish, avoidImpassableLandMedium);
   rmPlaceObjectDefAtLoc(northFish, 0, 0.0, 1.0, 3 * cNumberNonGaiaPlayers);
   ...
   rmSetObjectDefMaxDistance(northFish2, rmXFractionToMeters(0.60));
...
//********************************************************************************//
   ...
   rmSetObjectDefMaxDistance(southFish, rmZFractionToMeters(0.60));
   rmAddObjectDefConstraint(southFish, southTeam);
   rmAddObjectDefConstraint(southFish, avoidAllMedium);
   rmAddObjectDefConstraint(southFish, avoidImpassableLandMedium);
   rmPlaceObjectDefAtLoc(southFish, 0, 0.0, 0.5, 3 * cNumberNonGaiaPlayers);
   ...
   rmSetObjectDefMaxDistance(southFish2, rmZFractionToMeters(0.60));
