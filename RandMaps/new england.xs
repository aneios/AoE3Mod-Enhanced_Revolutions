...
//   rmDefineClass("classForest");
   ...
   // Resource avoidance
	...
	int forestConstraintFar=rmCreateClassDistanceConstraint("forest vs. forest far", rmClassID("Forest"), 24.0);
...
//	rmAddObjectDefConstraint(startingUnits, avoidAll);
   ...
   int whaleVsWhaleID=rmCreateTypeDistanceConstraint("whale v whale", "minkeWhale", 28+2*cNumberNonGaiaPlayers);
...
//non 1v1 mines
	...
	rmAddObjectDefItem(Trees1ID, "TreeNewEngland", 12, 8.0);
