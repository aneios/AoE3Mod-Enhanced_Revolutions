...
// ********************* MAP PARAMETERS ************************
	...
	int avoidBison=rmCreateTypeDistanceConstraint("avoid Bison", "Bison", 35);
	int avoidPronghorn=rmCreateTypeDistanceConstraint("avoid Pronghorn", "Pronghorn", 35);
	...
	int avoidNuggetLong=rmCreateClassDistanceConstraint("nugget vs. nugget long", rmClassID("classNugget"), 60.0);
	int avoidNugget=rmCreateClassDistanceConstraint("nugget vs. nugget", rmClassID("classNugget"), 30.0);
	...
	int avoidStartingUnitsSmall=rmCreateClassDistanceConstraint("objects avoid starting units small", rmClassID("startingUnit"), 4.0);
...
// starting resources
	...
	int startingUnits = rmCreateStartingUnitsObjectDef(6.0);
    ...
    rmSetObjectDefMaxDistance(playerSilverID, 12.0);
