...
//	string nativeName1 = "native Huron village";
   ...
   // Resource avoidance
	...
	int avoidMooseFar = rmCreateTypeDistanceConstraint("avoid moose far", "moose", 62.0);
	int avoidMoose = rmCreateTypeDistanceConstraint("avoid moose", "moose", 54.0);
	...
	int avoidCaribouFar = rmCreateTypeDistanceConstraint("avoid caribou far", "caribou", 64.0);
	int avoidCaribou = rmCreateTypeDistanceConstraint("avoid  caribou", "caribou", 55.0);
	...
	int avoidElk = rmCreateTypeDistanceConstraint("elk avoids elk", "elk", 54.0);
	...
	int avoidMuskOxFar = rmCreateTypeDistanceConstraint("avoid muskox far", "muskOx", 66.0);
	int avoidMuskOx = rmCreateTypeDistanceConstraint("avoid muskox ", "muskOx", 55.0);
	...
	int avoidGoldFar = rmCreateClassDistanceConstraint ("gold avoid gold far", rmClassID("Gold"), 75.0);
//	int avoidGoldVeryFar = rmCreateClassDistanceConstraint ("gold avoid gold very ", rmClassID("Gold"), 74.0);
	...
	int avoidNuggetFar = rmCreateTypeDistanceConstraint("nugget avoid nugget Far", "AbstractNugget", 58.0);
...
//	int avoidTownCenterMed=rmCreateTypeDistanceConstraint("avoid Town Center med", "townCenter", 40.0);
	...
	int avoidSheep=rmCreateTypeDistanceConstraint("sheep avoids sheep", "sheep", 66.0);
