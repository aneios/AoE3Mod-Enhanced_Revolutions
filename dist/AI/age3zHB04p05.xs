//==============================================================================
/*  age3zhb04p05.xs
	Fort Duquesne, Player 5. This is the standard AI. It is used for the Lenni Lennape (Iroquois) player. The AI becomes active once the player liberates the village. 
*/
//==============================================================================
...
void preInit(void)
{
   ...
   btBiasInf = 0.75;				// High tendency to build Infantry
