...
/* age3hb08p03.xs
   ...
   Player 3, Purple enemy, mildly agressive ai 
...
void preInit(void)
{
	...
	btBiasArt = -0.25;			// Low tendency to build artillery
    btBiasInf = -0.25;			// Low tendency to build Infantry
    btBiasCav = 1.0;		    // Tendency to build Cavalry
