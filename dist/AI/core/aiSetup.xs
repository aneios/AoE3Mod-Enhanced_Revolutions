...
void initArrays(void)
{
   ...
   gMapNames = xsArrayCreateString(235, "", "Map names");
   ...
   xsArraySetString(gMapNames, 238, "euwales");
   xsArraySetString(gMapNames, 239, "euwaleslarge");
   xsArraySetString(gMapNames, 240, "eumuscovy");
   xsArraySetString(gMapNames, 241, "eumuscovylarge");
...
void analyzeGameSettingsAndType()
{
      ...
      case cDifficultyHard: // Hard.
   {
      ...
      else
      {
         ...
         aiSetMicroFlags(cMicroLevelNormal);
            gAttackMissionInterval = 150000; // 2.5 Minutes.
      }
      break;
   }
   ...
   {
      gMaxPop = maxPop;
         gAttackMissionInterval = 120000; // 2 Minutes.
