...
void main(void)
{
	...
	int avoidBighornSheep = rmCreateTypeDistanceConstraint("avoid bighornsheep", "BighornSheep", 55.0);
...
else
{
	...
	rmSetObjectDefMaxDistance(StartBighornSheepID, 13);
	...
	rmAddObjectDefItem(StartElkT, "Elk", rmRandInt(10, 11), 6.0);
	...
	int northforestcount = PlayerNum * 20; // 6
