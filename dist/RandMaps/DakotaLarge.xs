...
void main(void)
{
   ...
   int avoidDeer = rmCreateTypeDistanceConstraint("Deer avoids food", hunt1, 70.0);
   int avoidDeerPond = rmCreateTypeDistanceConstraint("Deer avoids food1", hunt1, 10.0);
   int avoidElk = rmCreateTypeDistanceConstraint("Elk avoids food", "Elk", 70.0);
   ...
   int avoidNuggetSmall1 = rmCreateTypeDistanceConstraint("avoid nuggets by a little1", "AbstractNugget", 24.0);
   int avoidFastCoin = rmCreateTypeDistanceConstraint("fast coin avoids coin", "gold", 75);
   int avoidFastCoinTeam = rmCreateTypeDistanceConstraint("fast coin avoids coin team", "gold", 88);
