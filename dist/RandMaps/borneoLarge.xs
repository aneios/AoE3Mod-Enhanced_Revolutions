...
// Constraints
  ...
  int playerConstraintNugget=rmCreateClassDistanceConstraint("stay away from players far", classPlayer, 55.0);
	...
	int forestConstraintFar=rmCreateClassDistanceConstraint("forest vs. forest far", rmClassID("classForest"), 50.0);
  ...
  // resource avoidance
	int avoidSilver=rmCreateTypeDistanceConstraint("avoid silver", "mine", 85.0);
  ...
  int avoidHuntable1=rmCreateTypeDistanceConstraint("avoid huntable1", huntable1, 70.0);
	int avoidHuntable2=rmCreateTypeDistanceConstraint("avoid huntable2", huntable2, 70.0);
  int avoidNuggetsShort=rmCreateTypeDistanceConstraint("vs nugget short", "AbstractNugget", 10.0);
  int avoidNuggets=rmCreateTypeDistanceConstraint("nugget vs. nugget", "AbstractNugget", 50.0);
	int avoidNuggetFar=rmCreateTypeDistanceConstraint("nugget vs. nugget far", "AbstractNugget", 80.0);
  int avoidNuggetWater=rmCreateTypeDistanceConstraint("nugget vs. nugget water", "AbstractNugget", 100.0);
  ...
  int fishVsFishID=rmCreateTypeDistanceConstraint("fish v fish", fish1, 20.0);	
	int fishVsFish2ID=rmCreateTypeDistanceConstraint("fish v fish2", fish2, 20.0); 
	int fishLand = rmCreateTerrainDistanceConstraint("fish land", "land", true, 8.0);			
  
  int whaleVsWhaleID=rmCreateTypeDistanceConstraint("whale v whale", whale1, 65.0);
...
// Forests
  ...
  if (cNumberNonGaiaPlayers < 5) {
    ...
    rmPlaceObjectDefAtLoc(fish3ID, 0, 0.5, 0.5, 5+10*cNumberNonGaiaPlayers);
  }  
