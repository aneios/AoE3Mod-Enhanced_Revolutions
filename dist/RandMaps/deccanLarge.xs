// East India Trading Company - Deccan LARGE
// August 06 - PJJ
...
void main(void)
{
  ...
  if (cNumberNonGaiaPlayers == 2)
    avoidElephants = rmCreateTypeDistanceConstraint("avoid elephants far", "ypWildElephant", 120.0);
  else
    avoidElephants = rmCreateTypeDistanceConstraint("avoid elephants far", "ypWildElephant", 90.0);
    ...
    if(whichVersion == 1) {
      ...
      if(randomRiver == 1)
      {
        if (cNumberNonGaiaPlayers > 6)
          ...
          rmSetPlacementSection(0.06, 0.23);    // this is being used for treaty
      }
      else 
      ...
      if(randomRiver == 1)
      {
        if (cNumberNonGaiaPlayers > 6)
          ...
          rmSetPlacementSection(.53, .70);    // this is being used for treaty
      }
      else 
...
else
{
    ...
    {
	  	rmPlaceGroupingAtLoc(nativeID0, 0, 0.55, 0.75);
