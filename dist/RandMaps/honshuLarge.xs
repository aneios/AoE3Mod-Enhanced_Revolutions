...
// initialize map type variables
  ...
  string playerTerrain = "coastal_japan\ground_dirt3_co_japan";
  string playerTerrain2 = "coastal_japan\ground_dirt1_co_japan";  
...
void main(void)
{
  ...
  avoidCoinShort=rmCreateTypeDistanceConstraint("avoid coin short", "minegold", 40.0);	
  ...
  if (cNumberTeams == 2 ) {
    ...
    rmAddAreaTerrainLayer(id, playerTerrain2, 0, 1);
  ...
  rmEchoInfo("70 percent map loaded");
	...
	rmSetObjectDefMaxDistance(TCID, 2.5); //10
