...
// ***************** CHOOSE NATIVES ******************
   ...
   int nativeMix=rmRandInt(0,1);
	...
	{
		natType1 = "navajo";
		natGrpName1 = "native navajo village ";
	}
...
// ********************* MAP PARAMETERS ************************
	...
	int avoidSilver=rmCreateTypeDistanceConstraint("gold avoid gold", "Mine", 64.0);
	...
	int mediumForestConstraint=rmCreateClassDistanceConstraint("medium forest vs. forest", rmClassID("classForest"), 36.0);
	...
	int avoidBison=rmCreateTypeDistanceConstraint("avoid Bison", "Bison", 55);
	int avoidPronghorn=rmCreateTypeDistanceConstraint("avoid Pronghorn", "Pronghorn", 55);
	...
	int avoidNuggetLong=rmCreateClassDistanceConstraint("nugget vs. nugget long", rmClassID("classNugget"), 75.0);
	int avoidNugget=rmCreateClassDistanceConstraint("nugget vs. nugget", rmClassID("classNugget"), 50.0);
    ...
    int avoidHunt2_dk=rmCreateTypeDistanceConstraint("herds avoid herds2_dk", "huntable", 25.0);
    ...
    int avoidGoldTypeFar_dk = rmCreateTypeDistanceConstraint("avoid gold type  far 2_dk", "mine", 35.0);
...
// starting resources
    ...
    if(cNumberNonGaiaPlayers==2){
        rmSetObjectDefMinDistance(playerSilverID, 8.0);
        rmSetObjectDefMaxDistance(playerSilverID, 14.0);
    }else{
	...
	rmAddObjectDefConstraint(playerNuggetID, circleConstraint2_dk);
...
//   ----------------------------Bison Herd-----------------------------------
	...
	rmAddObjectDefItem(startBisonID, "bison", 8, 4.0);
	rmSetObjectDefCreateHerd(startBisonID, true);
	rmSetObjectDefMinDistance(startBisonID, 14);
	rmSetObjectDefMaxDistance(startBisonID, 14);
	...
	int startBison2ID = rmCreateObjectDef("starting bison2");
	rmAddObjectDefItem(startBison2ID, "bison", 8, 8.0);
	rmSetObjectDefCreateHerd(startBison2ID, true);
	rmSetObjectDefMinDistance(startBison2ID, 30);
	rmSetObjectDefMaxDistance(startBison2ID, 33);
	rmAddObjectDefToClass(startBison2ID, rmClassID("startingUnit"));
	rmAddObjectDefConstraint(startBison2ID, avoidImpassableLand);
	rmAddObjectDefConstraint(startBison2ID, shortAvoidImportantItem);
	// rmAddObjectDefConstraint(startBison2ID, avoidTradeRoute);
	rmAddObjectDefConstraint(startBison2ID, avoidStartingUnits);
	rmAddObjectDefConstraint(startBison2ID, avoidResource);
...
// 2 team and FFA support
	...
	else if ( cNumberTeams <= 2 && teamZeroCount <= 4 && teamOneCount <= 4)
	{
		...
		rmPlacePlayersCircular(0.37, 0.37, 0);		// rmPlacePlayersCircular(0.38, 0.40, 0);
	...
	{	
		...
		rmSetAreaTerrainType(westDesertID, "Yellow_river\stone1_yellow_riv");
 ...
 /*
   ...
   // ******************************* PLACE BIG MESA ****************************
	...
	rmPlaceObjectDefAtLoc(bigMesaID, 0, 0.50, 0.50);
...
//    *********************************** PLACE NATIVES *************************
	...
	{  
		...
		if (cNumberTeams == 2) 
		{
			if (randomPlacement <= 8)
				rmPlaceGroupingAtLoc(apacheVillageID, 0, 0.45, 0.80);  //KSW ---> Was 0.82, 0.5
			else
				rmPlaceGroupingAtLoc(apacheVillageID, 0, 0.45, 0.83);
		}
		else 
		{
			rmPlaceGroupingAtLoc(apacheVillageID, 0, 0.70, 0.50);
		}
	}
	...
	{  
		...
		navajoVillageID = rmCreateGrouping("navajo village", natGrpName1+navajoVillageType);
		...
		{
			if (randomPlacement <= 8)
				rmPlaceGroupingAtLoc(navajoVillageID, 0, 0.45, 0.80);  //KSW ---> Was 0.82, 0.5
			else
				rmPlaceGroupingAtLoc(navajoVillageID, 0, 0.45, 0.83);
		}
		else 
		{
			rmPlaceGroupingAtLoc(navajoVillageID, 0, 0.70, 0.50);
		}
	}
	...
	if (subCiv1 == rmGetCivID(natType1))
	{
		...
		{		
			if (randomPlacement <= 8)
				rmPlaceGroupingAtLoc(navajoVillageID, 0, 0.48, 0.60);
			else
				rmPlaceGroupingAtLoc(navajoVillageID, 0, 0.48, 0.63);
		}
		else
		{
			rmPlaceGroupingAtLoc(navajoVillageID, 0, 0.50, 0.70);
		}
	}
	...
	if (subCiv1 == rmGetCivID("apache"))
	{
		...
		{				
			if (randomPlacement <= 8)
				rmPlaceGroupingAtLoc(apacheVillageID, 0, 0.48, 0.60);
			else
				rmPlaceGroupingAtLoc(apacheVillageID, 0, 0.48, 0.63);
		}
		else
		{
			rmPlaceGroupingAtLoc(apacheVillageID, 0, 0.50, 0.70);
		}
	}
	...
	if (subCiv2 == rmGetCivID(natType1))
	{
		...
		navajoVillageType = rmRandInt(1,5);
		randomPlacement = rmRandInt(1,10);
		navajoVillageID = rmCreateGrouping("navajo village2", natGrpName1+navajoVillageType);
		rmSetGroupingMinDistance(navajoVillageID, 0.0);
		rmSetGroupingMaxDistance(navajoVillageID, 20.0);
		rmAddGroupingConstraint(navajoVillageID, avoidImpassableLand);
		rmAddGroupingToClass(navajoVillageID, rmClassID("natives"));
		...
		{				
			if (randomPlacement <= 8)
				rmPlaceGroupingAtLoc(navajoVillageID, 0, 0.52, 0.40);
			else
				rmPlaceGroupingAtLoc(navajoVillageID, 0, 0.52, 0.33);
		}
		else
		{
			rmPlaceGroupingAtLoc(navajoVillageID, 0, 0.50, 0.30);
		}
	}
	...
	if (subCiv2 == rmGetCivID("apache"))
	{
		...
		{				
			if (randomPlacement <= 8)
				rmPlaceGroupingAtLoc(apacheVillageID, 0, 0.52, 0.40);
			else
				rmPlaceGroupingAtLoc(apacheVillageID, 0, 0.52, 0.35);
		}
		else 
		{
			rmPlaceGroupingAtLoc(apacheVillageID, 0, 0.50, 0.30);
		}
	}
	...
	if (subCiv3 == rmGetCivID(natType1))
	{
		...
		{	
			if (randomPlacement <= 8)
				rmPlaceGroupingAtLoc(navajoVillageID, 0, 0.55, 0.20);
			else
				rmPlaceGroupingAtLoc(navajoVillageID, 0, 0.55, 0.17);
		}
		else 
		{
			rmPlaceGroupingAtLoc(navajoVillageID, 0, 0.30, 0.50);
		}
	}
	...
	if (subCiv3 == rmGetCivID("apache"))
	{
		...
		{
			if (randomPlacement <= 8)
				rmPlaceGroupingAtLoc(apacheVillageID, 0, 0.55, 0.20);
			else
				rmPlaceGroupingAtLoc(apacheVillageID, 0, 0.55, 0.17);
		}
		else
		{
			rmPlaceGroupingAtLoc(apacheVillageID, 0, 0.30, 0.50);
		}
	}
...
// ---------------------- *** Place Players and Starting Units *** -------------------------------------------------------------------
	...
	for(i=1; <cNumberPlayers)
	{
		...
		rmPlaceObjectDefAtLoc(startBison2ID, 0, rmPlayerLocXFraction(i), rmPlayerLocZFraction(i));
...
// ************************************ FORESTS **************************************
	...
	for(i=0; < 2+cNumberNonGaiaPlayers*6)
	{
	...
	//	rmAddAreaConstraint(edgeForestID, avoidTradeRouteSockets);
		...
		rmAddAreaConstraint(edgeForestID, avoidKOTH);
...
if(cNumberNonGaiaPlayers>2){
   ...
   //1v1 mines
    ...
    rmSetObjectDefMaxDistance(topMine, 16);
    ...
    //center mines
    int mineVariant=rmRandInt(1,2);
    int centerMineFlip = rmRandInt(1,3);
    int topCenterMineFlip = rmRandInt(1,3);
    int plainsMineFlip = rmRandInt(1,2);
    //centerMineFlip =2; //debug
   // mineVariant=3;
    if(mineVariant==1){
        //bot mines
        rmPlaceObjectDefAtLoc(topMine, 0, 0.32, 0.2, 1);
        rmPlaceObjectDefAtLoc(topMine, 0, 0.68, 0.2, 1);
        //center mines
        rmPlaceObjectDefAtLoc(topMine, 0, 0.38, 0.48, 1);
        rmPlaceObjectDefAtLoc(topMine, 0, 0.62, 0.48, 1);
        //top center mine
        rmPlaceObjectDefAtLoc(topMine, 0, 0.5, 0.9, 1);
        rmPlaceObjectDefAtLoc(topMine, 0, 0.5, 0.7, 1);
        //top side mines
        rmPlaceObjectDefAtLoc(topMine, 0, 0.25, 0.8, 1);
        rmPlaceObjectDefAtLoc(topMine, 0, 0.75, 0.8, 1);
    }else if(mineVariant==2){
        //bot mines
        rmPlaceObjectDefAtLoc(topMine, 0, 0.32, 0.2, 1);
        rmPlaceObjectDefAtLoc(topMine, 0, 0.68, 0.2, 1);
        //center mines
        ...
        rmPlaceObjectDefAtLoc(topMine, 0, 0.62, 0.48, 1);
        //top center mine
        rmPlaceObjectDefAtLoc(topMine, 0, 0.6, 0.85, 1);
        rmPlaceObjectDefAtLoc(topMine, 0, 0.4, 0.85, 1);
        //top side mines
        rmPlaceObjectDefAtLoc(topMine, 0, 0.2, 0.65, 1);
        rmPlaceObjectDefAtLoc(topMine, 0, 0.8, 0.65, 1);
        ...
        rmPlaceObjectDefAtLoc(topMine, 0, 0.68, 0.2, 1);
        //center mines
        rmPlaceObjectDefAtLoc(topMine, 0, 0.5, 0.58, 1);
        rmPlaceObjectDefAtLoc(topMine, 0, 0.5, 0.34, 1);
        //top center mine
        rmPlaceObjectDefAtLoc(topMine, 0, 0.6, 0.85, 1);
        rmPlaceObjectDefAtLoc(topMine, 0, 0.4, 0.85, 1);
        //top side mines
...
// ------------------------------------- *** Random Trees *** ------------------------------------------------
	...
	// ************************************ TREASURES ***********************************
		...
		rmSetObjectDefMaxDistance(nugget4, rmXFractionToMeters(0.20));
		...
		rmAddObjectDefConstraint(nugget4, circleConstraint2_dk);
		...
		if (cNumberNonGaiaPlayers > 2 && rmGetIsTreaty() == false)
			rmPlaceObjectDefAtLoc(nugget4, 0, 0.5, 0.5, rmRandInt(1,3));
		...
		rmAddObjectDefConstraint(nugget3, circleConstraint2_dk);
		...
		rmSetObjectDefMaxDistance(nugget2, rmXFractionToMeters(0.48));
		...
		rmAddObjectDefConstraint(nugget2, circleConstraint2_dk);
		...
		rmSetObjectDefMaxDistance(nugget1, rmXFractionToMeters(0.48));
		...
		rmAddObjectDefConstraint(nugget1, circleConstraint2_dk);
		rmAddObjectDefConstraint(nugget1, avoidKOTH);
		rmAddObjectDefConstraint(nugget1, shortAvoidImportantItem);			// Added New
		rmPlaceObjectDefAtLoc(nugget1, 0, 0.5, 0.5, 4*cNumberNonGaiaPlayers);
...
if(cNumberNonGaiaPlayers>2){
	...
	rmSetObjectDefMaxDistance(cowID, rmXFractionToMeters(0.45));
	rmAddObjectDefConstraint(cowID, avoidCow);
	// rmAddObjectDefConstraint(cowID, avoidAll);
	rmAddObjectDefConstraint(cowID, longPlayerConstraint);
	...
	rmAddObjectDefConstraint(cowID, avoidKOTH);					// Added New
...
if(cNumberNonGaiaPlayers>2){
	...
	rmAddObjectDefItem(bisonID, "bison", 8, 6.0);
...
// --------------------------- *** Place Pronghorn Herds *** -------------------------------
	...
	rmSetObjectDefMaxDistance(pronghornID, rmXFractionToMeters(0.45));
	...
	rmAddObjectDefConstraint(pronghornID, avoidKOTH);					// Added New
    ...
    rmAddObjectDefItem(mapHunts, "bison", 8, 6.0);
    ...
    rmAddObjectDefItem(mapHuntsDeer, "pronghorn", 8, 6.0);
    ...
    rmAddObjectDefConstraint(mapHuntsDeer, avoidKOTH);
    
    int huntFlip = rmRandInt(1,3);
    //huntFlip=1;
    if(huntFlip==1){
        //these comments are unusually scuffed
        //center line hunts
        rmPlaceObjectDefAtLoc(mapHunts, 0, 0.5, 0.80, 1);
        rmPlaceObjectDefAtLoc(mapHunts, 0, 0.5, 0.5, 1);
        //
        rmPlaceObjectDefAtLoc(mapHunts, 0, 0.38, 0.32, 1);
        rmPlaceObjectDefAtLoc(mapHunts, 0, 0.62, 0.32, 1);
        //off center hunts
        rmPlaceObjectDefAtLoc(mapHunts, 0, 0.35, 0.55, 1);
        rmPlaceObjectDefAtLoc(mapHunts, 0, 0.65, 0.55, 1);
        //back corner hunts
        rmPlaceObjectDefAtLoc(mapHunts, 0, 0.15, 0.7, 1);
        rmPlaceObjectDefAtLoc(mapHunts, 0, 0.85, 0.7, 1);
        //top corner hunts
        rmPlaceObjectDefAtLoc(mapHuntsDeer, 0, 0.70, 0.90, 1);
        rmPlaceObjectDefAtLoc(mapHuntsDeer, 0, 0.30, 0.90, 1);
        //bot corner hunts
        rmPlaceObjectDefAtLoc(mapHunts, 0, 0.20, 0.2, 1);
        rmPlaceObjectDefAtLoc(mapHunts, 0, 0.80, 0.2, 1);
        rmPlaceObjectDefAtLoc(mapHuntsDeer, 0, 0.42, 0.14, 1);
        rmPlaceObjectDefAtLoc(mapHuntsDeer, 0, 0.58, 0.14, 1);
    }else if(huntFlip==2){
        //center line
        rmPlaceObjectDefAtLoc(mapHunts, 0, 0.5, 0.18, 1);
        rmPlaceObjectDefAtLoc(mapHuntsDeer, 0, 0.5, 0.43, 1);
        rmPlaceObjectDefAtLoc(mapHuntsDeer, 0, 0.5, 0.67, 1);
        rmPlaceObjectDefAtLoc(mapHunts, 0, 0.5, 0.9, 1);
        //left pocket
        rmPlaceObjectDefAtLoc(mapHunts, 0, 0.32, 0.57, 1);
        rmPlaceObjectDefAtLoc(mapHunts, 0, 0.12, 0.6, 1);
        rmPlaceObjectDefAtLoc(mapHunts, 0, 0.27, 0.78, 1);
        //right pocket
        rmPlaceObjectDefAtLoc(mapHunts, 0, 0.68, 0.57, 1);
        rmPlaceObjectDefAtLoc(mapHunts, 0, 0.88, 0.6, 1);
        rmPlaceObjectDefAtLoc(mapHunts, 0, 0.73, 0.78, 1);
        //bottom hunts
        rmPlaceObjectDefAtLoc(mapHuntsDeer, 0, 0.35, 0.1, 1);
        rmPlaceObjectDefAtLoc(mapHuntsDeer, 0, 0.65, 0.1, 1);
    }else{
        //center hunts
        rmPlaceObjectDefAtLoc(mapHunts, 0, 0.5, 0.45, 1);
        rmPlaceObjectDefAtLoc(mapHuntsDeer, 0, 0.34, 0.5, 1);
        rmPlaceObjectDefAtLoc(mapHuntsDeer, 0, 0.66, 0.55, 1);
        rmPlaceObjectDefAtLoc(mapHunts, 0, 0.5, 0.7, 1);
        //bottom hunts
        rmPlaceObjectDefAtLoc(mapHuntsDeer, 0, 0.41, 0.25, 1);
        rmPlaceObjectDefAtLoc(mapHuntsDeer, 0, 0.59, 0.25, 1);
        rmPlaceObjectDefAtLoc(mapHunts, 0, 0.25, 0.15, 1);
        rmPlaceObjectDefAtLoc(mapHunts, 0, 0.75, 0.15, 1);
        //top hunts
        rmPlaceObjectDefAtLoc(mapHunts, 0, 0.35, 0.85, 1);
        rmPlaceObjectDefAtLoc(mapHunts, 0, 0.65, 0.85, 1);
        rmPlaceObjectDefAtLoc(mapHunts, 0, 0.15, 0.65, 1);
        rmPlaceObjectDefAtLoc(mapHunts, 0, 0.85, 0.65, 1);
    }
    
    if(cNumberNonGaiaPlayers==2){
        //1v1 cows
        int mapCows = rmCreateObjectDef("mapCows");
        rmAddObjectDefItem(mapCows, "cow", 1, 1.0);
        rmSetObjectDefMinDistance(mapCows, 0);
        rmSetObjectDefMaxDistance(mapCows, 16);
        ...
        rmAddObjectDefConstraint(mapCows, avoidKOTH);
        int cowVariation=rmRandInt(1,3);
        //cowVariation=3;
        if(cowVariation==1){
            rmPlaceObjectDefAtLoc(mapCows, 0, 0.5, 0.52, 1);
            rmPlaceObjectDefAtLoc(mapCows, 0, 0.5, 0.25, 1);
            rmPlaceObjectDefAtLoc(mapCows, 0, 0.25, 0.15, 1);
            rmPlaceObjectDefAtLoc(mapCows, 0, 0.75, 0.15, 1);
            rmPlaceObjectDefAtLoc(mapCows, 0, 0.41, 0.85, 1);
            rmPlaceObjectDefAtLoc(mapCows, 0, 0.59, 0.85, 1);
            rmPlaceObjectDefAtLoc(mapCows, 0, 0.15, 0.65, 1);
            rmPlaceObjectDefAtLoc(mapCows, 0, 0.85, 0.65, 1);
        }else if(cowVariation==2){           
            rmPlaceObjectDefAtLoc(mapCows, 0, 0.5, 0.65, 1);
            rmPlaceObjectDefAtLoc(mapCows, 0, 0.5, 0.35, 1);
            rmPlaceObjectDefAtLoc(mapCows, 0, 0.2, 0.2, 1);
            rmPlaceObjectDefAtLoc(mapCows, 0, 0.8, 0.2, 1);
            rmPlaceObjectDefAtLoc(mapCows, 0, 0.5, 0.12, 1);
            rmPlaceObjectDefAtLoc(mapCows, 0, 0.5, 0.88, 1);
            rmPlaceObjectDefAtLoc(mapCows, 0, 0.2, 0.8, 1);
            rmPlaceObjectDefAtLoc(mapCows, 0, 0.8, 0.8, 1);
        }else{
            rmPlaceObjectDefAtLoc(mapCows, 0, 0.4, 0.5, 1);
            rmPlaceObjectDefAtLoc(mapCows, 0, 0.6, 0.5, 1);
            rmPlaceObjectDefAtLoc(mapCows, 0, 0.2, 0.2, 1);
            rmPlaceObjectDefAtLoc(mapCows, 0, 0.8, 0.2, 1);
            rmPlaceObjectDefAtLoc(mapCows, 0, 0.5, 0.12, 1);
            rmPlaceObjectDefAtLoc(mapCows, 0, 0.5, 0.88, 1);
