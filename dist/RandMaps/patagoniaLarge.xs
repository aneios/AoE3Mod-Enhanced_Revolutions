...
void main(void)
{
    ...
    int westForestConstraint=rmCreateClassDistanceConstraint("west forest vs. forest", rmClassID("classWestForest"), 50.0);
    ...
    int avoidDeerMH=rmCreateTypeDistanceConstraint("bighorn avoids bighorn", "deer", 64.0); // was 40
    int avoidHunt=rmCreateTypeDistanceConstraint("hunt avoid hunt", "huntable", 50.0);
   ...
   int whaleVsWhaleID = rmCreateTypeDistanceConstraint("whale v whale", "beluga", 55.0);
    ...
    int avoidFastCoin45=rmCreateTypeDistanceConstraint("fast coin avoids coin 45", "gold", 75.0);
    ...
    int avoidHunt2=rmCreateTypeDistanceConstraint("herds avoid herds2", "huntable", 50.0);
...
//	rmAddObjectDefConstraint(playerNuggetID, avoidStartingUnitsSmall);
   ...
   int forestTreeID = 0;
   numTries=4+4*cNumberNonGaiaPlayers;
   int failCount=0;
   for (i=0; <numTries)
      {   
   ...
   numTries=cNumberNonGaiaPlayers*4+2;
   failCount=0;
   for (i=0; <numTries)
      {   
