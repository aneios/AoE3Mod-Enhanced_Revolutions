...
// ************************** DEFINE OBJECTS ****************************
  ...
  int deerID=rmCreateObjectDef("huntable1");
	rmAddObjectDefItem(deerID, huntable1, rmRandInt(9,9), 6.0);
  ...
  int tapirID=rmCreateObjectDef("huntable2");
	rmAddObjectDefItem(tapirID, huntable2, rmRandInt(9,9), 6.0);
...
// Players
  ...
  // Set up player areas.
  float playerFraction=rmAreaTilesToFraction(111);
