...
//	isItWet = 2;		// for testing
//	whichMap = 3;		// for testing
	...
	if (TeamNum == 2 && teamZeroCount == teamOneCount)
			size=40*PlayerNum+400; 
	if (TeamNum > 2 || teamZeroCount != teamOneCount)
			size=75*PlayerNum+500;
...
//	rmSetBaseTerrainMix(paintMix2);
	...
	int avoidHunt3Far = rmCreateTypeDistanceConstraint("avoid hunt3 far", food3, 75.0);
	int avoidHunt3VeryFar = rmCreateTypeDistanceConstraint("avoid hunt3 very far", food3, 90.0);
	int avoidHunt3 = rmCreateTypeDistanceConstraint("avoid hunt3", food3, 44.0);
	...
	int avoidHunt2VeryFar = rmCreateTypeDistanceConstraint("avoid hunt2 very far", food2, 90.0);
	int avoidHunt2 = rmCreateTypeDistanceConstraint("avoid hunt2", food2, 44.0);
	...
	int avoidHunt1VeryFar = rmCreateTypeDistanceConstraint("avoid hunt1 very far", food1, 90.0);
	...
	int avoidGoldType = rmCreateTypeDistanceConstraint("coin avoids coin ", "gold", 64.0);
	...
	int avoidGold = rmCreateClassDistanceConstraint ("gold avoid gold med", rmClassID("Gold"), 64.0);
	int avoidGoldFar = rmCreateClassDistanceConstraint ("gold avoid gold far", rmClassID("Gold"), 90.0);
	int avoidGoldVeryFar = rmCreateClassDistanceConstraint ("gold avoid gold very far", rmClassID("Gold"), 144.0);
	...
	int avoidGold2 = rmCreateClassDistanceConstraint ("gold avoid gold2 med", rmClassID("Gold2"), 64.0);
	int avoidGold2Far = rmCreateClassDistanceConstraint ("gold avoid gold2 far", rmClassID("Gold2"), 90.0);
	int avoidGold2VeryFar = rmCreateClassDistanceConstraint ("gold avoid gold2 very far", rmClassID("Gold2"), 144.0);
	...
	int avoidCliffVeryFar = rmCreateClassDistanceConstraint("avoid cliff very far", rmClassID("Cliffs"), 75+5*PlayerNum);
	...
	int avoidCattle = rmCreateTypeDistanceConstraint("cow avoid cow", cattleType, 90+PlayerNum);
...
//		rmSetAreaMix(kingsIslandID, "mongolia_grass"); 	// for testing
	...
	// Starting buildings
	int playerOutpostID = rmCreateObjectDef("player outpost 1");
	rmAddObjectDefItem(playerOutpostID, "Outpost", 1, 0);
	rmSetObjectDefMinDistance(playerOutpostID, 20.0);
	rmSetObjectDefMaxDistance(playerOutpostID, 22.0);
	rmAddObjectDefToClass(playerOutpostID, classStartingResource);
	rmAddObjectDefConstraint(playerOutpostID, avoidStartingResourcesShort);
	rmAddObjectDefConstraint(playerOutpostID, avoidNatives);
	rmAddObjectDefConstraint(playerOutpostID, avoidTradeRouteShort);
	rmAddObjectDefConstraint(playerOutpostID, avoidTradeRouteSocketShort);
	if (TeamNum == 2 && teamZeroCount == teamOneCount)	
		rmAddObjectDefConstraint(playerOutpostID, stayMidIsland);

	int playerOutpost2ID = rmCreateObjectDef("player outpost 2");
	rmAddObjectDefItem(playerOutpost2ID, "Outpost", 1, 0);
	rmSetObjectDefMinDistance(playerOutpost2ID, 20.0);
	rmSetObjectDefMaxDistance(playerOutpost2ID, 22.0);
	rmAddObjectDefToClass(playerOutpost2ID, classStartingResource);
	rmAddObjectDefConstraint(playerOutpost2ID, avoidStartingResourcesShort);
	rmAddObjectDefConstraint(playerOutpost2ID, avoidNatives);
	rmAddObjectDefConstraint(playerOutpost2ID, avoidTradeRouteShort);
	rmAddObjectDefConstraint(playerOutpost2ID, avoidTradeRouteSocketShort);
	rmAddObjectDefConstraint(playerOutpost2ID, avoidMidIslandMin);

	int playerBlockhouseID = rmCreateObjectDef("player blockhouse 1");
	rmAddObjectDefItem(playerBlockhouseID, "Blockhouse", 1, 0);
	rmSetObjectDefMinDistance(playerBlockhouseID, 20.0);
	rmSetObjectDefMaxDistance(playerBlockhouseID, 22.0);
	rmAddObjectDefToClass(playerBlockhouseID, classStartingResource);
	rmAddObjectDefConstraint(playerBlockhouseID, avoidStartingResourcesShort);
	rmAddObjectDefConstraint(playerBlockhouseID, avoidNatives);
	rmAddObjectDefConstraint(playerBlockhouseID, avoidTradeRouteShort);
	rmAddObjectDefConstraint(playerBlockhouseID, avoidTradeRouteSocketShort);
	if (TeamNum == 2 && teamZeroCount == teamOneCount)	
		rmAddObjectDefConstraint(playerBlockhouseID, stayMidIsland);

	int playerBlockhouse2ID = rmCreateObjectDef("player blockhouse 2");
	rmAddObjectDefItem(playerBlockhouse2ID, "Blockhouse", 1, 0);
	rmSetObjectDefMinDistance(playerBlockhouse2ID, 20.0);
	rmSetObjectDefMaxDistance(playerBlockhouse2ID, 22.0);
	rmAddObjectDefToClass(playerBlockhouse2ID, classStartingResource);
	rmAddObjectDefConstraint(playerBlockhouse2ID, avoidStartingResourcesShort);
	rmAddObjectDefConstraint(playerBlockhouse2ID, avoidNatives);
	rmAddObjectDefConstraint(playerBlockhouse2ID, avoidTradeRouteShort);
	rmAddObjectDefConstraint(playerBlockhouse2ID, avoidTradeRouteSocketShort);
	rmAddObjectDefConstraint(playerBlockhouse2ID, avoidMidIslandMin);

	int playerWarHutID = rmCreateObjectDef("player wh 1");
	rmAddObjectDefItem(playerWarHutID, "WarHut", 1, 0);
	rmSetObjectDefMinDistance(playerWarHutID, 20.0);
	rmSetObjectDefMaxDistance(playerWarHutID, 22.0);
	rmAddObjectDefToClass(playerWarHutID, classStartingResource);
	rmAddObjectDefConstraint(playerWarHutID, avoidStartingResourcesShort);
	rmAddObjectDefConstraint(playerWarHutID, avoidNatives);
	rmAddObjectDefConstraint(playerWarHutID, avoidTradeRouteShort);
	rmAddObjectDefConstraint(playerWarHutID, avoidTradeRouteSocketShort);
	if (TeamNum == 2 && teamZeroCount == teamOneCount)	
		rmAddObjectDefConstraint(playerWarHutID, stayMidIsland);

	int playerWarHut2ID = rmCreateObjectDef("player wh 2");
	rmAddObjectDefItem(playerWarHut2ID, "WarHut", 1, 0);
	rmSetObjectDefMinDistance(playerWarHut2ID, 20.0);
	rmSetObjectDefMaxDistance(playerWarHut2ID, 22.0);
	rmAddObjectDefToClass(playerWarHut2ID, classStartingResource);
	rmAddObjectDefConstraint(playerWarHut2ID, avoidStartingResourcesShort);
	rmAddObjectDefConstraint(playerWarHut2ID, avoidNatives);
	rmAddObjectDefConstraint(playerWarHut2ID, avoidTradeRouteShort);
	rmAddObjectDefConstraint(playerWarHut2ID, avoidTradeRouteSocketShort);
	rmAddObjectDefConstraint(playerWarHut2ID, avoidMidIslandMin);

	int playerAsianOutpostID = rmCreateObjectDef("player asian outpost 1");
	rmAddObjectDefItem(playerAsianOutpostID, "ypOutpostAsian", 1, 0);
	rmSetObjectDefMinDistance(playerAsianOutpostID, 20.0);
	rmSetObjectDefMaxDistance(playerAsianOutpostID, 22.0);
	rmAddObjectDefToClass(playerAsianOutpostID, classStartingResource);
	rmAddObjectDefConstraint(playerAsianOutpostID, avoidStartingResourcesShort);
	rmAddObjectDefConstraint(playerAsianOutpostID, avoidNatives);
	rmAddObjectDefConstraint(playerAsianOutpostID, avoidTradeRouteShort);
	rmAddObjectDefConstraint(playerAsianOutpostID, avoidTradeRouteSocketShort);
	if (TeamNum == 2 && teamZeroCount == teamOneCount)	
		rmAddObjectDefConstraint(playerAsianOutpostID, stayMidIsland);

	int playerAsianOutpost2ID = rmCreateObjectDef("player asian outpost 2");
	rmAddObjectDefItem(playerAsianOutpost2ID, "ypOutpostAsian", 1, 0);
	rmSetObjectDefMinDistance(playerAsianOutpost2ID, 20.0);
	rmSetObjectDefMaxDistance(playerAsianOutpost2ID, 22.0);
	rmAddObjectDefToClass(playerAsianOutpost2ID, classStartingResource);
	rmAddObjectDefConstraint(playerAsianOutpost2ID, avoidStartingResourcesShort);
	rmAddObjectDefConstraint(playerAsianOutpost2ID, avoidNatives);
	rmAddObjectDefConstraint(playerAsianOutpost2ID, avoidTradeRouteShort);
	rmAddObjectDefConstraint(playerAsianOutpost2ID, avoidTradeRouteSocketShort);
	rmAddObjectDefConstraint(playerAsianOutpost2ID, avoidMidIslandMin);

	int playerAfricanTowerID = rmCreateObjectDef("player african tower");
	rmAddObjectDefItem(playerAfricanTowerID, "deTower", 1, 0);
	rmSetObjectDefMinDistance(playerAfricanTowerID, 20.0);
	rmSetObjectDefMaxDistance(playerAfricanTowerID, 22.0);
	rmAddObjectDefToClass(playerAfricanTowerID, classStartingResource);
	rmAddObjectDefConstraint(playerAfricanTowerID, avoidStartingResourcesShort);
	rmAddObjectDefConstraint(playerAfricanTowerID, avoidNatives);
	rmAddObjectDefConstraint(playerAfricanTowerID, avoidTradeRouteShort);
	rmAddObjectDefConstraint(playerAfricanTowerID, avoidTradeRouteSocketShort);
	if (TeamNum == 2 && teamZeroCount == teamOneCount)	
		rmAddObjectDefConstraint(playerAfricanTowerID, stayMidIsland);

	int playerBarracksID = rmCreateObjectDef("player rax");
	rmAddObjectDefItem(playerBarracksID, "Barracks", 1, 0);
	rmSetObjectDefMinDistance(playerBarracksID, 20.0);
	rmSetObjectDefMaxDistance(playerBarracksID, 22.0);
	rmAddObjectDefToClass(playerBarracksID, classStartingResource);
	rmAddObjectDefConstraint(playerBarracksID, avoidStartingResourcesShort);
	rmAddObjectDefConstraint(playerBarracksID, avoidNatives);
	rmAddObjectDefConstraint(playerBarracksID, avoidTradeRouteShort);
	rmAddObjectDefConstraint(playerBarracksID, avoidTradeRouteSocketShort);
	rmAddObjectDefConstraint(playerBarracksID, avoidMidIslandMin);

	int playerStockadeID = rmCreateObjectDef("player rax Indian");
	rmAddObjectDefItem(playerStockadeID, "ypBarracksIndian", 1, 0);
	rmSetObjectDefMinDistance(playerStockadeID, 20.0);
	rmSetObjectDefMaxDistance(playerStockadeID, 22.0);
	rmAddObjectDefToClass(playerStockadeID, classStartingResource);
	rmAddObjectDefConstraint(playerStockadeID, avoidStartingResourcesShort);
	rmAddObjectDefConstraint(playerStockadeID, avoidNatives);
	rmAddObjectDefConstraint(playerStockadeID, avoidTradeRouteShort);
	rmAddObjectDefConstraint(playerStockadeID, avoidTradeRouteSocketShort);
	rmAddObjectDefConstraint(playerStockadeID, avoidMidIslandMin);

	int playerWarAcademyID = rmCreateObjectDef("player war academy");
	rmAddObjectDefItem(playerWarAcademyID, "ypWarAcademy", 1, 0);
	rmSetObjectDefMinDistance(playerWarAcademyID, 20.0);
	rmSetObjectDefMaxDistance(playerWarAcademyID, 22.0);
	rmAddObjectDefToClass(playerWarAcademyID, classStartingResource);
	rmAddObjectDefConstraint(playerWarAcademyID, avoidStartingResourcesShort);
	rmAddObjectDefConstraint(playerWarAcademyID, avoidNatives);
	rmAddObjectDefConstraint(playerWarAcademyID, avoidTradeRouteShort);
	rmAddObjectDefConstraint(playerWarAcademyID, avoidTradeRouteSocketShort);
	rmAddObjectDefConstraint(playerWarAcademyID, avoidMidIslandMin);

	int playerBanshoID = rmCreateObjectDef("player Bansho");
	rmAddObjectDefItem(playerBanshoID, "ypBarracksJapanese", 1, 0);
	rmSetObjectDefMinDistance(playerBanshoID, 20.0);
	rmSetObjectDefMaxDistance(playerBanshoID, 22.0);
	rmAddObjectDefToClass(playerBanshoID, classStartingResource);
	rmAddObjectDefConstraint(playerBanshoID, avoidStartingResourcesShort);
	rmAddObjectDefConstraint(playerBanshoID, avoidNatives);
	rmAddObjectDefConstraint(playerBanshoID, avoidTradeRouteShort);
	rmAddObjectDefConstraint(playerBanshoID, avoidTradeRouteSocketShort);
	rmAddObjectDefConstraint(playerBanshoID, avoidMidIslandMin);

	int playerWarCampID = rmCreateObjectDef("player rawar campx");
	rmAddObjectDefItem(playerWarCampID, "deWarCamp", 1, 0);
	rmSetObjectDefMinDistance(playerWarCampID, 20.0);
	rmSetObjectDefMaxDistance(playerWarCampID, 22.0);
	rmAddObjectDefToClass(playerWarCampID, classStartingResource);
	rmAddObjectDefConstraint(playerWarCampID, avoidStartingResourcesShort);
	rmAddObjectDefConstraint(playerWarCampID, avoidNatives);
	rmAddObjectDefConstraint(playerWarCampID, avoidTradeRouteShort);
	rmAddObjectDefConstraint(playerWarCampID, avoidTradeRouteSocketShort);
	rmAddObjectDefConstraint(playerWarCampID, avoidMidIslandMin);
	...
	for(i=1; <numPlayer)
	{
		...
		if (rmGetNomadStart() == false) {
			...
			if (rmGetPlayerCiv(i) == rmGetCivID("Russians")) {
				rmPlaceObjectDefAtLoc(playerBlockhouseID, i, rmXMetersToFraction(xsVectorGetX(TCLoc)), rmZMetersToFraction(xsVectorGetZ(TCLoc)));
				rmPlaceObjectDefAtLoc(playerBlockhouse2ID, i, rmXMetersToFraction(xsVectorGetX(TCLoc)), rmZMetersToFraction(xsVectorGetZ(TCLoc)));
				}
			// Asians 2 Asian Outposts and 1 culturally appropriate rax
			else if (rmGetPlayerCiv(i) == rmGetCivID("Chinese")) {
				rmPlaceObjectDefAtLoc(playerAsianOutpostID, i, rmXMetersToFraction(xsVectorGetX(TCLoc)), rmZMetersToFraction(xsVectorGetZ(TCLoc)));
				rmPlaceObjectDefAtLoc(playerAsianOutpost2ID, i, rmXMetersToFraction(xsVectorGetX(TCLoc)), rmZMetersToFraction(xsVectorGetZ(TCLoc)));
				rmPlaceObjectDefAtLoc(playerWarAcademyID, i, rmXMetersToFraction(xsVectorGetX(TCLoc)), rmZMetersToFraction(xsVectorGetZ(TCLoc)));
				}
			else if (rmGetPlayerCiv(i) == rmGetCivID("Japanese")) {
				rmPlaceObjectDefAtLoc(playerAsianOutpostID, i, rmXMetersToFraction(xsVectorGetX(TCLoc)), rmZMetersToFraction(xsVectorGetZ(TCLoc)));
				rmPlaceObjectDefAtLoc(playerAsianOutpost2ID, i, rmXMetersToFraction(xsVectorGetX(TCLoc)), rmZMetersToFraction(xsVectorGetZ(TCLoc)));
				rmPlaceObjectDefAtLoc(playerBanshoID, i, rmXMetersToFraction(xsVectorGetX(TCLoc)), rmZMetersToFraction(xsVectorGetZ(TCLoc)));
				}
			else if (rmGetPlayerCiv(i) == rmGetCivID("Indians")) {
				rmPlaceObjectDefAtLoc(playerAsianOutpostID, i, rmXMetersToFraction(xsVectorGetX(TCLoc)), rmZMetersToFraction(xsVectorGetZ(TCLoc)));
				rmPlaceObjectDefAtLoc(playerAsianOutpost2ID, i, rmXMetersToFraction(xsVectorGetX(TCLoc)), rmZMetersToFraction(xsVectorGetZ(TCLoc)));
				rmPlaceObjectDefAtLoc(playerStockadeID, i, rmXMetersToFraction(xsVectorGetX(TCLoc)), rmZMetersToFraction(xsVectorGetZ(TCLoc)));
				}
			// TWC civs get 2 WHs
				...
				rmPlaceObjectDefAtLoc(playerWarHutID, i, rmXMetersToFraction(xsVectorGetX(TCLoc)), rmZMetersToFraction(xsVectorGetZ(TCLoc)));
				rmPlaceObjectDefAtLoc(playerWarHut2ID, i, rmXMetersToFraction(xsVectorGetX(TCLoc)), rmZMetersToFraction(xsVectorGetZ(TCLoc)));
				}
			// Africans get a tower and a war camp
			else if (rmGetPlayerCiv(i) == rmGetCivID("DEHausa") || rmGetPlayerCiv(i) == rmGetCivID("DEEthiopians")) {
				rmPlaceObjectDefAtLoc(playerAfricanTowerID, i, rmXMetersToFraction(xsVectorGetX(TCLoc)), rmZMetersToFraction(xsVectorGetZ(TCLoc)));
				rmPlaceObjectDefAtLoc(playerWarCampID, i, rmXMetersToFraction(xsVectorGetX(TCLoc)), rmZMetersToFraction(xsVectorGetZ(TCLoc)));
				}
			// All others 2 outposts and a rax
			else {
				rmPlaceObjectDefAtLoc(playerOutpostID, i, rmXMetersToFraction(xsVectorGetX(TCLoc)), rmZMetersToFraction(xsVectorGetZ(TCLoc)));
				rmPlaceObjectDefAtLoc(playerOutpost2ID, i, rmXMetersToFraction(xsVectorGetX(TCLoc)), rmZMetersToFraction(xsVectorGetZ(TCLoc)));
				rmPlaceObjectDefAtLoc(playerBarracksID, i, rmXMetersToFraction(xsVectorGetX(TCLoc)), rmZMetersToFraction(xsVectorGetZ(TCLoc)));
				}
			}
...
//		rmPlaceObjectDefAtLoc(playerHerd2ID, i, rmXMetersToFraction(xsVectorGetX(TCLoc)), rmZMetersToFraction(xsVectorGetZ(TCLoc)));
	...
	if (whichMap == 4)
		rmSetAreaSize(centralPondID, 0.0169);
	else
		rmSetAreaSize(centralPondID, rmAreaTilesToFraction(444+PlayerNum*77));
...
//	rmAddAreaConstraint(centralPondID, stayGoldZone);
	...
	if (PlayerNum > 2) 
	{
		...
		rmSetObjectDefMaxDistance(midSilverID, rmXFractionToMeters(0.44));
	...
	else 
	{
		...
		while (minePlacement < 4) 	// 4 per player
		{
...
//		whichHeight = 1;	// for testing
		...
		rmAddObjectDefItem(cliffVegID, brushType1, rmRandInt(20,30), 20.0+PlayerNum);
	...
	// map forest patches
	int maptreecount = 20+15*PlayerNum;
...
//		rmAddObjectDefConstraint(dryGrassID, avoidTownCenterShort);
	...
	rmPlaceObjectDefAtLoc(Nugget1ID, 0, 0.50, 0.50, 2+3*PlayerNum);
	...
	int cowID=rmCreateObjectDef("moo");
		...
		rmPlaceObjectDefAtLoc(cowID, 0, 0.50, 0.50, 4+3*PlayerNum);
