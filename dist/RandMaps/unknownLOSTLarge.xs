...
// ============= Constraints =============
   ...
   int avoidNugget=rmCreateTypeDistanceConstraint("nugget avoid nugget", "abstractNugget", 18.0);
   int avoidNuggetMed=rmCreateTypeDistanceConstraint("nugget avoid nugget med", "abstractNugget", 24.0);
   ...
   int avoidFood = rmCreateTypeDistanceConstraint("food avoids food", "food", 40.0);
	int avoidFood1 = rmCreateTypeDistanceConstraint("food avoids food1", critterOneName, 55+3*cNumberNonGaiaPlayers);
	int avoidFood2 = rmCreateTypeDistanceConstraint("food avoids food2", critterTwoName, 55+3*cNumberNonGaiaPlayers);
	...
	int avoidGoldVeryFar = rmCreateClassDistanceConstraint("stay away from minerals very far", classGold, 70+2*cNumberNonGaiaPlayers);
...
// Usually 3 to 4, but rarely more or less
	...
	int nativeNumber = (rmRandInt(4,5)+(cNumberNonGaiaPlayers));
	if (tpORnot == 5)
		nativeNumber = (6+(cNumberNonGaiaPlayers));
...
int nugget4ID= rmCreateObjectDef("map nugget4"); 
	...
	if (cNumberNonGaiaPlayers > 2 && rmGetIsTreaty() == false)
		rmPlaceObjectDefAtLoc(nugget4ID, 0, 0.5, 0.5, 10+5*cNumberNonGaiaPlayers);
...
int nugget3ID= rmCreateObjectDef("map nugget3"); 
	...
	rmPlaceObjectDefAtLoc(nugget3ID, 0, 0.5, 0.5, 10+30*cNumberNonGaiaPlayers);
...
int nugget2ID= rmCreateObjectDef("map nugget2"); 
	...
	rmSetNuggetDifficulty(2,2);
	rmPlaceObjectDefAtLoc(nugget2ID, 0, 0.5, 0.5, 40*cNumberNonGaiaPlayers);
...
int nuggetID= rmCreateObjectDef("map nugget"); 
	...
	rmSetNuggetDifficulty(1,1);
	rmPlaceObjectDefAtLoc(nuggetID, 0, 0.5, 0.5, 40*cNumberNonGaiaPlayers);
