...
//   int longPlayerConstraint=rmCreateClassDistanceConstraint("land stays away from players", classPlayer, 24.0);
  ...
  // int nearWater10 = rmCreateTerrainDistanceConstraint("near water", "Water", true, 10.0);
   ...
   int whaleVsWhaleID=rmCreateTypeDistanceConstraint("whale v whale", "AbstractWhale", 32.0);
   int whaleLand = rmCreateTerrainDistanceConstraint("whale v. land", "land", true, 14.0);
...
//  ***************************  Define and place Forests  *******************************
   ...
   for (i=0; <numTries)
   {
      ...
      {   
	   ...
	   rmSetAreaSize(forest2, rmAreaTilesToFraction(100), rmAreaTilesToFraction(200));
...
// **************************  Resources that can be placed after forests (Hunting)  ***************************
	...
	int tapirCount = rmRandInt(5,5);
	int capyCount = rmRandInt(7,7);
